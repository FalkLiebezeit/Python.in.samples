...
The Takagi function T(x) is defined on the interval [0,1] as:
T(x) = \sum_{n=0}^{\infty} \frac{\phi(2^n x)}{2^n}
Where:
- \phi(x) = \min_{k \in \mathbb{Z}} |x - k| is the distance from x to the nearest integer.
- This creates a series of scaled triangle wave functions.
