...
class Aufgabe:
    ...
    def auswerten(self):
        match self:
            case Aufgabe(operator=op, op1=int(op1), op2=int(op2)):
                match op:
                    case "+": return op1 + op2
                    case "-": return op1 - op2
                    case "*": return op1 * op2
            ...
            case Aufgabe(operator=op, op1=Aufgabe() as op1, op2=op2):
                return Aufgabe(op1.auswerten(), op, op2).auswerten()
            case Aufgabe(operator=op, op1=op1, op2=Aufgabe() as op2):
