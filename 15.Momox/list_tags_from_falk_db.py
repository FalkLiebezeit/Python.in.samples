#!/usr/bin/env python
"""
Lists all data from the 'tags' table in the falk.db database.
"""
...
def main():
    ...
    database_path = base_path / "Falk.db"
    
    # Check if database exists
    if not database_path.exists():
        print(f"Error: Database not found at {database_path}")
        print("Please ensure 'Falk.db' exists in the same directory as this script.")
        return
