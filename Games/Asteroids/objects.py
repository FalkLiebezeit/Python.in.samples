...
class Rocket(pygame.sprite.Sprite):
	def __init__(self, winsize):
		...
		self.surf = pygame.image.load('Python-Games/Asteroids/assets/rocket.png').convert()
...
class Asteroid(pygame.sprite.Sprite):
	def __init__(self, type, winsize):
		...
		asteroid_types = {i:f'Python-Games/Asteroids/assets/asteroids/asteroid{i}.png' for i in range(1,6)}
...
class Explosion(pygame.sprite.Sprite):
	def __init__(self, pos):
		...
		self.images = []
		for i in range(17):
			file = f'Python-Games/Asteroids/assets/explosion/Explosion{i}.png'
